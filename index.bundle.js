...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./Fonts/Montserrat-ExtraLight.ttf */ "./src/Fonts/Montserrat-ExtraLight.ttf"), __webpack_require__.b);
...
.navbar {
    background-color: rgb(107, 166, 218);
    display: flex;
...
.popup-box {
    ...
    align-items: center;
    z-index: 5;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,yBAAyB;IACzB,4CAA2C;AAC/C;;AAEA;IACI,sBAAsB;IACtB,4CAA+C;AACnD;;AAEA;IACI,SAAS;IACT,UAAU;IACV,yBAAyB;AAC7B;;AAEA;IACI,gCAAgC;IAChC,YAAY;IACZ,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,UAAU;AACd;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,kBAAkB;AACtB;;AAEA;IACI,oCAAoC;IACpC,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,eAAe;IACf,aAAa;IACb,mBAAmB;IACnB,YAAY;IACZ,6BAA6B;AACjC;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,YAAY;IACZ,WAAW;IACX,mBAAmB;AACvB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,sBAAsB;IACtB;AACJ;;AAEA;IACI,oCAAoC;IACpC,aAAa;IACb,8BAA8B;IAC9B,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,gBAAgB;IAChB,YAAY;IACZ,kBAAkB;IAClB,oBAAoB;AACxB;;AAEA;IACI,aAAa;IACb,uCAAuC;IACvC,2BAA2B;IAC3B,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;AACvB;;AAEA;IACI,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,kBAAkB;IAClB,uBAAuB;IACvB,UAAU;IACV,aAAa;IACb,mBAAmB;IACnB,sBAAsB;IACtB,YAAY;IACZ,6BAA6B;IAC7B,uBAAuB;IACvB,mBAAmB;IACnB,UAAU;AACd","sourcesContent":["@font-face {\n    font-family: 'Montserrat';\n    src: url(./Fonts/Montserrat-ExtraLight.ttf);\n}\n\n@font-face {\n    font-family: 'Raleway';\n    src: url(./Fonts/Raleway-VariableFont_wght.ttf);\n}\n\nbody {\n    margin: 0;\n    padding: 0;\n    font-family: 'Montserrat';\n}\n\n.grey-out {\n    background-color: lightslategray;\n    opacity: 0.5;\n    width: 100%;\n    height: 100%;\n    position: absolute;\n    z-index: 3;\n}\n\n.content {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    position: relative;\n}\n\n.navbar {\n    background-color: rgb(107, 166, 218);\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex-wrap: wrap;\n    padding: 10px;\n    margin-bottom: 20px;\n    width: 500px;\n    box-shadow: 5px 5px lightgray;\n}\n\nh1 {\n    margin: 15px;\n}\n\ninput, button {\n    padding: 5px;\n    margin: 5px;\n    border-radius: 10px;\n}\n\n.forecast {\n    width: 350px;\n    display: flex;\n    flex-direction: column;\n    box-shadow: 7px 7px lightblue\n}\n\n.current {\n    background-color: rgb(153, 187, 216);\n    display: grid;\n    grid-template-columns: 1fr 1fr;\n    padding: 30px;\n}\n\n.icon-large {\n    grid-row: 1/3;\n    grid-column: 2/3;\n    width: 100px;\n    align-self: center;\n    justify-self: center;\n}\n\n.day-table {\n    display: grid;\n    grid-template-columns: 1fr 1fr 1fr 42px;\n    background-color: aliceblue;\n    padding: 10px;\n    justify-content: space-between;\n    align-items: center;\n}\n\n.day-table img {\n    width: 40px;\n    height: 40px;\n}\n\n.popup-box {\n    position: absolute;\n    background-color: white;\n    top: 200px;\n    padding: 20px;\n    border-radius: 10px;\n    flex-direction: column;\n    width: 150px;\n    box-shadow: 5px 5px lightgray;\n    justify-content: center;\n    align-items: center;\n    z-index: 5;\n}"],"sourceRoot":""}]);
// Exports
...
function displayFuture(t0, c0, i0, t1, c1, i1, t2, c2, i2) {
    ...
    future.innerHTML = `
        <div class="day-table" id="today-table"><h4>${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(today, "iii dd/MM")}</h4><h3>${t0}&degC</h3><h3>${c0}</h3><img src="https://${i0}"></div>
        <div class="day-table" id="tomorrow-table"><h4>${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(today, 1), "iii dd/MM")}</h4><h3>${t1}&degC</h3><h3>${c1}</h3><img src="https://${i1}"></div>
        <div class="day-table" id="tomorrow-tomorrow-table"><h4>${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(today, 2), "iii dd/MM")}</h4><h3>${t2}&degC</h3><h3>${c2}</h3><img src="https://${i2}"></div>
    `
}
...
module.exports = __webpack_require__.p + "ef3c777f702c89a0f300.ttf";
...
/* harmony import */ var _build_page_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./build-page.js */ "./src/build-page.js");
...
(0,_build_page_js__WEBPACK_IMPORTED_MODULE_1__.buildPage)();
...
function getCurrentWeather(location) {
    ...
    .then(function(response) {
        ...
        (0,_build_page_js__WEBPACK_IMPORTED_MODULE_1__.displayCurrent)(city, country, currentTemp, icon);
        return;
    })
...
async function getFutureWeather(location) {
    ...
    (0,_build_page_js__WEBPACK_IMPORTED_MODULE_1__.displayFuture)(t0, c0, i0, t1, c1, i0, t2, c2, i2)
};
